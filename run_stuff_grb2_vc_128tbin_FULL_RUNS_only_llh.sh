...
if [ -f "filter_evdata.fits" ]; then
   ...
   #com python $batml_path'do_full_rates.py' --min_tbin $mintbin > full_rates.out 2>&1 &
   # python $batml_path'do_manage2.py' --GWname $gwname --rhel7 --do_bkg --do_rates --do_llh --queue jak51_b_g_vc_default --q hprc > manager.out 2>&1 &
    python $batml_path'do_manage2_vc_gw_July.py' --GWname $gwname --rhel7  --do_llh --queue jak51_b_g_vc_default --q hprc > manager.out 2>&1 &   
