...
#workdir='/gpfs/group/jak51/default/gzr5209/GW_subthr_results/re-runs_error4/'
#workdir='/storage/home/gzr5209/work/realtime_workdir/'
workdir='/storage/home/gzr5209/work/realtime_workdir_NITRATES/' # added on May 19th
...
if [ -f "filter_evdata.fits" ]; then
    ...
    python $batml_path'do_manage2_vc_new2.py' --GWname $gwname --rhel7 --do_bkg --do_rates --do_llh --queue jak51_b_g_vc_default --q hprc --N_infov_jobs 96 --N_outfov_jobs 24 > manager.out 2>&1 &
#    python $batml_path'do_manage2.py' --GWname $gwname --rhel7 --do_llh --queue jak51_b_g_vc_default --q hprc > manager.out 2>&1 & 
